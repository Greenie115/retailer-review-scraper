...
function updateMorrisonsHandler() {
  try {
    ...
    const morrisonsHandlerPath = path.join(__dirname, 'morrisons-handler-ratings-fixed.js');
    ...
    const backupPath = path.join(__dirname, 'review-scraper-crawlee-fixed.backup4.js');
