...
function updateTescoHandler() {
  try {
    ...
    const tescoHandlerPath = path.join(__dirname, 'tesco-handler-fixed.js');
    ...
    const backupPath = path.join(__dirname, 'review-scraper-crawlee-fixed.backup-tesco-fixed.js');
