...
function updateAsdaHandler() {
  try {
    ...
    const asdaHandlerPath = path.join(__dirname, 'asda-handler-simplified.js');
    ...
    const backupPath = path.join(__dirname, 'review-scraper-crawlee-fixed.backup-asda-simplified.js');
