...
function updateTescoHandler() {
  try {
    ...
    const tescoHandlerPath = path.join(__dirname, 'tesco-handler-wait-for-reviews.js');
    ...
    const backupPath = path.join(__dirname, 'review-scraper-crawlee-fixed.backup-tesco-wait.js');
