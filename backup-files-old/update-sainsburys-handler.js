...
function updateSainsburysHandler() {
  try {
    console.log('Starting to update the Sainsbury\'s handler...');
    ...
    const sainsburysHandlerPath = path.join(__dirname, 'sainsburys-handler-updated.js');
    ...
    const backupPath = path.join(__dirname, 'review-scraper-crawlee-fixed.backup-sainsburys-updated.js');
    ...
    console.log(`Updated ${filePath} with the new Sainsbury's handler`);
