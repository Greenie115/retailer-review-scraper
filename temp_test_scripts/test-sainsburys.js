...
// Test URL for a Sainsbury's product that likely has reviews
const testUrl = 'https://www.sainsburys.co.uk/gol-ui/product/sainsburys-taste-the-difference-vintage-cheddar-cheese-550g';

async function testScraper() {
  console.log(`Testing scraper with Sainsbury's product URL: ${testUrl}`);
